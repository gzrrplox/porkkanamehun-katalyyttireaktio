...
#define POINTS "1700.0"
const size_t num_points = 1700;

#define NOTES "1000.0"
const size_t num_notes = 1000;

#define RUNTIME "30.0"
const double runtime = 30;
...
int main() {
    ...
    init_shader(quad_source, NULL, filter_source, &filter_prog);
    init_shader(quad_source, NULL, display_source, &display_prog);
    init_shader(transform_source, bound_source, sample_source, &sample_prog);
    init_shader(quad_source, NULL, sound_render_source, &sound_render_prog);
